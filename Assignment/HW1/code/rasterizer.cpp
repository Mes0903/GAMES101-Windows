...
void rst::rasterizer::draw(rst::pos_buf_id pos_buffer, rst::ind_buf_id ind_buffer, rst::Primitive type) {
	if (type != rst::Primitive::Triangle) { throw std::runtime_error("Drawing primitives other than triangle is not implemented yet!"); }
...
void rst::rasterizer::rasterize_wireframe(Triangle const& t) {
	draw_line(t.c(), t.a());
	draw_line(t.c(), t.b());
	draw_line(t.b(), t.a());
}
